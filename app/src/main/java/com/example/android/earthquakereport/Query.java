...
public class Query {
    ...
    /* Create a private constructor because no one should create a Query object, only holds static*/
    private Query() {
    }
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONObject mainJsonResponse = new JSONObject(JSON_RESPONSE);
            JSONArray earthquakeArray = mainJsonResponse.getJSONArray("features");

            /*loop through each feature in the array*/
            for (int i = 0; i<earthquakeArray.length(); i++){

                /*Get json object at position 1*/
                JSONObject currentEarthquake = earthquakeArray.getJSONObject(i);
                /*get json properties "properties"*/
                JSONObject properties = currentEarthquake.getJSONObject("properties");
                /*gets the string value for mag*/
                double magnitude = properties.getDouble("mag");
                /*gets the string value for place*/
                String location = properties.getString("place");
                /*gets the string value for time*/
